    ...
    <section className='heroContainer'>
        <div className='outerBox' >
            <div className='buttons'>
                ...
                <div>
                <Button className={'commonBtn'}><CalenderIcon/> From date</Button>
                to
                <Button className={'commonBtn'}><CalenderIcon/> To date</Button>
                </div>
                <div>
                ...
                <Button className={'commonBtn filter'}><FilterIcon/> Filter</Button>
            </div>
